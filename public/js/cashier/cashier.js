...
if($('#cashiergraphtrigger').val()==1)
{
	...
	$('.addMedicalBilling').click(function(){
		...
		amountMedical = id[4];
		$.post('/display_medical_billing', {
			appointment_id:  appointmentIdMedical,
		}, function(data){
			var total = 0;
	...
	$('.addDentalBilling').click(function(){
		...
		amountDental = id[4];
		$.post('/display_dental_billing', {
			appointment_id:  appointmentIdDental
		}, function(data){
			var total = 0;
