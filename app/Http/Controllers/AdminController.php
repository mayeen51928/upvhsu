...
class AdminController extends Controller
{
	...
	{
		$params['unpaid'] = MedicalBilling::join('medical_appointments', 'medical_billings.medical_appointment_id', 'medical_appointments.id')->join('medical_schedules', 'medical_appointments.medical_schedule_id', 'medical_schedules.id')->whereDay('schedule_day', '=', date('Y-m-d'))->where('medical_billings.status', 'unpaid')->sum('amount') + DentalBilling::join('dental_appointments', 'dental_billings.appointment_id', 'dental_appointments.id')->join('dental_schedules', 'dental_appointments.dental_schedule_id', 'dental_schedules.id')->whereDate('schedule_start', '=', date('Y-m-d'))->where('dental_billings.status', 'unpaid')->sum('amount');
		$params['paid'] = MedicalBilling::join('medical_appointments', 'medical_billings.medical_appointment_id', 'medical_appointments.id')->join('medical_schedules', 'medical_appointments.medical_schedule_id', 'medical_schedules.id')->whereDay('schedule_day', '=', date('Y-m-d'))->where('medical_billings.status', 'paid')->sum('amount') + DentalBilling::join('dental_appointments', 'dental_billings.appointment_id', 'dental_appointments.id')->join('dental_schedules', 'dental_appointments.dental_schedule_id', 'dental_schedules.id')->whereDate('schedule_start', '=', date('Y-m-d'))->where('dental_billings.status', 'paid')->sum('amount');
