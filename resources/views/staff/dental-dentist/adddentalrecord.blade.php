...
<div class="container-fluid">
	<div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <svg height="522" width="867" style="margin-top:50px; ">
...
@for ($i = 11; $i < 86; $i++)
<div class="modal fade" id="update-dental-record-modal-{{ $i }}" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="add-dental-record">
          <select class="form-control condition" id="condition_{{ $i }}">
          ...
          <select class="form-control operation" id="form-control operation_{{ $i }}">
            <option disabled selected value="0">--options--</option>
