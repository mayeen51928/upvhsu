...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="cashierDashboard">
      <div class="col-md-9">
      ...
      <div class="col-md-12">
          <div class="clearfix">
          <div class="pull-left">
          <a href="{{ url('cashier/profile/edit') }}" class="btn btn-primary" role="button">Edit Profile</a>
          </div>
          </div>
          </div>
    </div>
