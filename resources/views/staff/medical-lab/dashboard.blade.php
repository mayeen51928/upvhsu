						...
						<div id="labdiagnosisaccordion" class="panel-collapse collapse">
							<div class="panel-body">
								<div class="laboratory-result-lab" id="laboratoryresult-lab"  style="padding:5px;">
							    	...
							    	<div class="radio">
								      <label><input type="radio" class="cbc_radio" value="inside" name="cbc_radio" checked>Inside</label>
								    </div>
								    <div class="radio">
								      <label><input type="radio" class="cbc_radio" value="outside" name="cbc_radio">Outside</label>
								    </div>
									</div>
									<div class="col-md-10">
									...
									<div class="col-md-2">
										DRUG TEST
										<div class="radio">
								      <label><input type="radio" class="drug_radio" value="inside" name="drug_radio" checked>Inside</label>
								    </div>
								    <div class="radio">
								      <label><input type="radio" class="drug_radio" value="outside" name="drug_radio">Outside</label>
								    </div>
									</div>
									<div class="col-md-10">
									<div class="form-group">
									...
									<div class="col-md-2">
										FECALYSIS
										<div class="radio">
								      <label><input type="radio" class="fecalysis_radio" value="inside" name="fecalysis_radio" checked>Inside</label>
								    </div>
								    <div class="radio">
								      <label><input type="radio" class="fecalysis_radio" value="outside" name="fecalysis_radio">Outside</label>
								    </div>
									</div>
									<div class="col-md-10">
									<div class="form-group">
									...
									<div class="col-md-2">
										URINALYSIS
										<div class="radio">
								      <label><input type="radio" class="urinalysis_radio" value="inside" name="urinalysis_radio" checked>Inside</label>
								    </div>
								    <div class="radio">
								      <label><input type="radio" class="urinalysis_radio" value="outside" name="urinalysis_radio">Outside</label>
								    </div>
									</div>
									<div class="col-md-10">
									<div class="form-group">
