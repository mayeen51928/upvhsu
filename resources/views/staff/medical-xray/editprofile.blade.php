...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="xrayDashboard">
      <form method="POST" action="/xray/profile/update" enctype="multipart/form-data">
			<div class="col-md-9">
